...
#' association analysis using negative binomial (mixed) models, 
...
#' The bottom panels illustrate the number of genes associated with each peak 
#' and the number of peaks linked to each gene.
#' 
...
#' 
#' @references eQTL analysis by Linear Model. http://www.bios.unc.edu/~weisun/software/eMap.pdf
#' 
#' @examples
#' 
#' RNA = ENCODE_RNA
